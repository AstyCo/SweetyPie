...
void GanttPlayerSettings::initActions()
{
    ...
    p_action = new QAction(QIcon(":/images/player_buttons/reg_speed_on_64.png"),QString::fromUtf8("Выбор скорости воспроизведения"),this);
...
//    p_action = new QAction(QIcon(":/images/player_buttons/reg_step_on_64.png"),QString::fromUtf8("выбор шага воспроизведения"),this);
//    addAction(p_action);
}
