...
void GanttIntervalSliderZoom::initActions()
{
    ...
    p_action = new QAction(QIcon(":/images/Buttons 64x64/more_click_32.png"),QString::fromUtf8("Вернуться к старым границам"),this);
    connect(p_action,SIGNAL(triggered(bool)),this,SIGNAL(restoreButtonClicked(bool)));
    addAction(p_action);

    p_action = new QAction(QIcon(":/images/Buttons 64x64/less_click_32.png"),QString::fromUtf8("Перейти к новым границам"),this);
